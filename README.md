...
<img title="Login menu, existing accounts " alt="Alt text" src="./img/login_exsiting_account.jpg" style="width:60%; heigh:80%;">
...
<img title="Computer vision for that image" alt="Alt text" src="./img/login_new_account.jpg" style="width:60%; heigh:80%;">
